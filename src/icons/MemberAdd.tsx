...
export interface MemberAddIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const MemberAddIcon = forwardRef<SVGSVGElement, MemberAddIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
MemberAddIcon.displayName = 'MemberAddIcon'
