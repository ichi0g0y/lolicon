...
export interface GithubFillIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const GithubFillIcon = forwardRef<SVGSVGElement, GithubFillIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
GithubFillIcon.displayName = 'GithubFillIcon'
