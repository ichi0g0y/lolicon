...
export interface DownFillIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const DownFillIcon = forwardRef<SVGSVGElement, DownFillIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
DownFillIcon.displayName = 'DownFillIcon'
