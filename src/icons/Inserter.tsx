...
export interface InserterIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const InserterIcon = forwardRef<SVGSVGElement, InserterIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
InserterIcon.displayName = 'InserterIcon'
