...
export interface FigmaFillIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const FigmaFillIcon = forwardRef<SVGSVGElement, FigmaFillIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
FigmaFillIcon.displayName = 'FigmaFillIcon'
