...
export interface PersonCardIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const PersonCardIcon = forwardRef<SVGSVGElement, PersonCardIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
