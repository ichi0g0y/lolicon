...
export interface LightbulbLowIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const LightbulbLowIcon = forwardRef<SVGSVGElement, LightbulbLowIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
LightbulbLowIcon.displayName = 'LightbulbLowIcon'
