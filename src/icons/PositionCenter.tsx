...
export interface PositionCenterIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const PositionCenterIcon = forwardRef<SVGSVGElement, PositionCenterIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
PositionCenterIcon.displayName = 'PositionCenterIcon'
