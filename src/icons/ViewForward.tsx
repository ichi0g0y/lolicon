...
export interface ViewForwardIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const ViewForwardIcon = forwardRef<SVGSVGElement, ViewForwardIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
ViewForwardIcon.displayName = 'ViewForwardIcon'
