...
export interface EmailFillIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const EmailFillIcon = forwardRef<SVGSVGElement, EmailFillIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
EmailFillIcon.displayName = 'EmailFillIcon'
