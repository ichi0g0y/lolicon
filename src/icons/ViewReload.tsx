...
export interface ViewReloadIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const ViewReloadIcon = forwardRef<SVGSVGElement, ViewReloadIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
ViewReloadIcon.displayName = 'ViewReloadIcon'
