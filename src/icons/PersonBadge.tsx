...
export interface PersonBadgeIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const PersonBadgeIcon = forwardRef<SVGSVGElement, PersonBadgeIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
    ...
    >
      <>
            <path d="M19 17C19 18.683 18.729 19.241 18.531 19.456C18.368 19.632 17.851 20 16 20C14.15 20 13.633 19.632 13.47 19.456C13.272 19.241 13 18.683 13 17C13 15.343 14.343 14 16 14C17.657 14 19 15.343 19 17ZM19.835 20.977C20.714 20.173 21 18.873 21 17C21 14.239 18.762 12 16 12C13.239 12 11 14.239 11 17C11 18.873 11.287 20.173 12.166 20.977C10.501 21.888 9.19601 23.373 8.51701 25.166C8.39301 25.494 8.36301 25.874 8.56801 26.159C9.13701 26.948 10.242 26.048 10.698 25.189C11.706 23.292 13.702 22 16 22C18.298 22 20.295 23.292 21.303 25.189C21.759 26.048 22.864 26.948 23.432 26.159C23.637 25.874 23.608 25.494 23.484 25.166C22.804 23.373 21.499 21.888 19.835 20.977Z" />
