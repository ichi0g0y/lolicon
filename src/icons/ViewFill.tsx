...
export interface ViewFillIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const ViewFillIcon = forwardRef<SVGSVGElement, ViewFillIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
ViewFillIcon.displayName = 'ViewFillIcon'
