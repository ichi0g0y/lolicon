...
export interface PhotoFillIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const PhotoFillIcon = forwardRef<SVGSVGElement, PhotoFillIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
PhotoFillIcon.displayName = 'PhotoFillIcon'
