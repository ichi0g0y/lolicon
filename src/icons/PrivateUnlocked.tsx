...
export interface PrivateUnlockedIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const PrivateUnlockedIcon = forwardRef<SVGSVGElement, PrivateUnlockedIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
PrivateUnlockedIcon.displayName = 'PrivateUnlockedIcon'
