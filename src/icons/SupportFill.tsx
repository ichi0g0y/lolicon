...
export interface SupportFillIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const SupportFillIcon = forwardRef<SVGSVGElement, SupportFillIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
SupportFillIcon.displayName = 'SupportFillIcon'
