...
export interface MessageSimpleIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const MessageSimpleIcon = forwardRef<SVGSVGElement, MessageSimpleIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
MessageSimpleIcon.displayName = 'MessageSimpleIcon'
