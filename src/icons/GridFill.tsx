...
export interface GridFillIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const GridFillIcon = forwardRef<SVGSVGElement, GridFillIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
