...
export interface ThumbsUpFillIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const ThumbsUpFillIcon = forwardRef<SVGSVGElement, ThumbsUpFillIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
