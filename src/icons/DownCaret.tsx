...
export interface DownCaretIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const DownCaretIcon = forwardRef<SVGSVGElement, DownCaretIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
DownCaretIcon.displayName = 'DownCaretIcon'
