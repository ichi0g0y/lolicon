...
export interface CalculatorFillIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const CalculatorFillIcon = forwardRef<SVGSVGElement, CalculatorFillIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
