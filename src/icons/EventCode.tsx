...
export interface EventCodeIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const EventCodeIcon = forwardRef<SVGSVGElement, EventCodeIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
