...
export interface TwitterFillIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const TwitterFillIcon = forwardRef<SVGSVGElement, TwitterFillIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
TwitterFillIcon.displayName = 'TwitterFillIcon'
