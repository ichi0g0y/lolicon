...
export interface RelaxedIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const RelaxedIcon = forwardRef<SVGSVGElement, RelaxedIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
RelaxedIcon.displayName = 'RelaxedIcon'
