...
export interface EventAddIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const EventAddIcon = forwardRef<SVGSVGElement, EventAddIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
EventAddIcon.displayName = 'EventAddIcon'
