...
export interface DoorLeaveIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const DoorLeaveIcon = forwardRef<SVGSVGElement, DoorLeaveIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
DoorLeaveIcon.displayName = 'DoorLeaveIcon'
