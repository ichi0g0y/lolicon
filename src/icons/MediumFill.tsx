...
export interface MediumFillIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const MediumFillIcon = forwardRef<SVGSVGElement, MediumFillIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
MediumFillIcon.displayName = 'MediumFillIcon'
