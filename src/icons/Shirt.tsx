...
export interface ShirtIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const ShirtIcon = forwardRef<SVGSVGElement, ShirtIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
    ...
    >
      <>
            ...
            <path d="M15.704 13.163c-2.762 0-5-2.238-5-5v-1a1 1 0 1 1 2 0v1a3 3 0 0 0 3 3h.5a3 3 0 0 0 3-3v-1a1 1 0 0 1 2 0v1c.001 2.762-2.238 5-5 5h-.5z" />
            <path d="M19.183 15.724c-.65-.64-1.948-.96-3.246.32-1.299-1.28-2.597-.96-3.246-.32-2.597 2.56 2.45 5.94 3.246 5.94.796 0 5.843-3.38 3.246-5.94z" />
          </>
    </svg>
  ),
)
