...
export interface EverythingIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const EverythingIcon = forwardRef<SVGSVGElement, EverythingIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
EverythingIcon.displayName = 'EverythingIcon'
