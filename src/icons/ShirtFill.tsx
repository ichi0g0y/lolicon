...
export interface ShirtFillIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const ShirtFillIcon = forwardRef<SVGSVGElement, ShirtFillIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
