...
export interface ViewBackIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const ViewBackIcon = forwardRef<SVGSVGElement, ViewBackIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
ViewBackIcon.displayName = 'ViewBackIcon'
