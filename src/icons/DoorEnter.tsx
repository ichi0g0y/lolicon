...
export interface DoorEnterIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const DoorEnterIcon = forwardRef<SVGSVGElement, DoorEnterIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
