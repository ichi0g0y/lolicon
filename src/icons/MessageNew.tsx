...
export interface MessageNewIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const MessageNewIcon = forwardRef<SVGSVGElement, MessageNewIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
MessageNewIcon.displayName = 'MessageNewIcon'
