...
export interface BoltDocsIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const BoltDocsIcon = forwardRef<SVGSVGElement, BoltDocsIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
BoltDocsIcon.displayName = 'BoltDocsIcon'
