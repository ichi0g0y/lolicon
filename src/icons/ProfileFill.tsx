...
export interface ProfileFillIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const ProfileFillIcon = forwardRef<SVGSVGElement, ProfileFillIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
ProfileFillIcon.displayName = 'ProfileFillIcon'
