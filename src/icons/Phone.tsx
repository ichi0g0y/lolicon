...
export const PhoneIcon = forwardRef<SVGSVGElement, PhoneIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
