...
export interface PositionTopLeftIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const PositionTopLeftIcon = forwardRef<SVGSVGElement, PositionTopLeftIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
PositionTopLeftIcon.displayName = 'PositionTopLeftIcon'
