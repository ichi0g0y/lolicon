...
export interface CameraFillIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const CameraFillIcon = forwardRef<SVGSVGElement, CameraFillIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
