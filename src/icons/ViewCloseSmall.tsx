...
export interface ViewCloseSmallIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const ViewCloseSmallIcon = forwardRef<SVGSVGElement, ViewCloseSmallIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
ViewCloseSmallIcon.displayName = 'ViewCloseSmallIcon'
