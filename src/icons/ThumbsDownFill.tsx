...
export interface ThumbsDownFillIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const ThumbsDownFillIcon = forwardRef<SVGSVGElement, ThumbsDownFillIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
