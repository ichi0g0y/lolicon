...
export interface ThermometerHalfIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const ThermometerHalfIcon = forwardRef<SVGSVGElement, ThermometerHalfIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
