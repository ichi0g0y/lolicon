...
export interface PositionTopRightIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const PositionTopRightIcon = forwardRef<SVGSVGElement, PositionTopRightIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
