...
export interface LightbulbFillIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const LightbulbFillIcon = forwardRef<SVGSVGElement, LightbulbFillIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
