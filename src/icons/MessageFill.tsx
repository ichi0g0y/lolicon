...
export interface MessageFillIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const MessageFillIcon = forwardRef<SVGSVGElement, MessageFillIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
