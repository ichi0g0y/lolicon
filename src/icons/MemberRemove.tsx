...
export interface MemberRemoveIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const MemberRemoveIcon = forwardRef<SVGSVGElement, MemberRemoveIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
MemberRemoveIcon.displayName = 'MemberRemoveIcon'
