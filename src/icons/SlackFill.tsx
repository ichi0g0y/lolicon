...
export interface SlackFillIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const SlackFillIcon = forwardRef<SVGSVGElement, SlackFillIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
