...
export interface UpFillIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const UpFillIcon = forwardRef<SVGSVGElement, UpFillIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
UpFillIcon.displayName = 'UpFillIcon'
