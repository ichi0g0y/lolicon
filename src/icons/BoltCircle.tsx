...
export interface BoltCircleIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const BoltCircleIcon = forwardRef<SVGSVGElement, BoltCircleIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
BoltCircleIcon.displayName = 'BoltCircleIcon'
