...
export interface TerminalPromptIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const TerminalPromptIcon = forwardRef<SVGSVGElement, TerminalPromptIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
