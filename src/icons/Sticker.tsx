...
export interface StickerIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const StickerIcon = forwardRef<SVGSVGElement, StickerIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
