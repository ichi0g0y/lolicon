...
export interface PostFillIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const PostFillIcon = forwardRef<SVGSVGElement, PostFillIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
PostFillIcon.displayName = 'PostFillIcon'
