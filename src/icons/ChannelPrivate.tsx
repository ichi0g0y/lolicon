...
export interface ChannelPrivateIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

export const ChannelPrivateIcon = forwardRef<SVGSVGElement, ChannelPrivateIconProps>(
  ({ size = 32, ...props }, ref) => (
    <svg
      ref={ref}
      fillRule="evenodd"
...
ChannelPrivateIcon.displayName = 'ChannelPrivateIcon'
